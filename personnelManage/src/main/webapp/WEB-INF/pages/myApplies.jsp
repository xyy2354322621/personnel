...
<div>
    <table>
        ...
        <tr>
            ...
            <th>面试状态</th><th>录用状态</th><th>面试答复</th>
        </tr>
            ...
            <tr>
                ...
                <td>
                    <c:if test="${apply.invite=='已邀请'}">
                        <a href="agreeInvite?apply_no=${sessionScope.apply.apply_no}&recruit_no=${sessionScope.apply.recruit_no}">同意面试</a>
                        <a href="refuseInvite?apply_no=${sessionScope.apply.apply_no}&recruit_no=${sessionScope.apply.recruit_no}">拒绝面试</a>
                    </c:if>
                </td>
            </tr>
        </c:forEach>
