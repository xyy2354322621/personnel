...
<div>
    <form method="post" action="vacationUpdate">
        ...
        请假时长：<input id="time" name="time" type="number" max="480" pattern="^[1-9]\d{0,2}$" value="480" ><span id="unit">分钟（最多为480分钟）</span>
