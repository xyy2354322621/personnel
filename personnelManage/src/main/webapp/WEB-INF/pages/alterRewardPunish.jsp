...
<fieldset>
    ...
    <form action="updateRewardPunish" method="post">
        ...
        被奖惩人：<input type="text" value="${rewardAanPunish.e_name}" readonly><br>
        奖惩类别：
        ...
        奖惩原因：<br>
        <textarea name="reason">${rewardAanPunish.reason}</textarea><br>
        奖惩金额：<input name="money" type="text" value="${rewardAanPunish.money}" placeholder="输入整数(最多8位)" pattern="^[1-9]\d{0,7}\.?\d{0,2}$" ><br>
        奖惩日期：<input type="date" name="time" value="${rewardAanPunish.time}"><br>
